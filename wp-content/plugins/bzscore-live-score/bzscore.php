...
public function bz_validate_options( $fields ) { 
    ...
    $bz_keywords=array();
        ...
        $bz_keywords['de']=array("Liveergebnisse","live ticker","live ticker","liveticker","liveticker","livescore","ergebnisse","live fussball ergebnisse","Fußball Liveergebnisse","Fußball","livescore Fußball","fussball ergebnisse gestern","livescore");
        $bz_keywords['pt']=array("futebol ao vivo","livescore","futebol live","futebol","livescore futebol","resultados","resultados","resultados live");
        $bz_keywords['nl']=array("voetbal live","voetbal","livescore","livescore voetbal","uitslagen voetbal live","live voetbal");
        $bz_keywords['tr']=array('canlı skor','canlı skor','canlı skor','maç sonuçları','maç sonuçları','maç sonuçları','iddaa sonuçları','iddaa','iddaa','iddaa','iddaa','canlı maç sonuçları');
        $bz_keywords['si']=array("nogomet","rezultati","rezultati v živo","nogomet v živo","livescore nogomet","livescore");
        $bz_keywords['rs']=array("fudbal","rezultati","rezultati uživo","fudbal uživo","livescore fudbal","livescore");
        $bz_keywords['it']=array("calcio","punteggio in tempo reale","risultati calcio di ieri","calcio di ieri","risultati partite ieri","risultati calcio","risultati calcio live score","livescore ieri","risultato in tempo reale","risultati dal vivo","risultati","livescore calcio","livescore");
        $bz_keywords['fr']=array("foot","en direct","livescore demain","en direct foot","score en direct","livescore foot","livescore","résultats de football","résultat hier","livescore hier","resultat foot");
        $bz_keywords['ro']=array("fotbal","in direct","scor in direct","scoruri live","scor live","scoruri in direct","rezultate live","livescore fotbal","livescore","rezultate");
...
function bz_code($atts) {
    ...
    $bz_your_code .= '<script type="text/javascript" src="https://www.livescore.bz/api.livescore.0.1.js?v1.3" api="livescore" async></script><a href="'.$bz_domain.'" sport="'. $atts['sport'] .'" data-1="'. $atts['data'] .'" data-2="'. $atts['data-2'] .'" lang="'. $bz_lang_is_x   .'">'. $bz_your_word_is .'</a>';
